...
static rosidl_typesupport_introspection_c__MessageMember bboxes_ex_msgs__msg__BoundingBoxes__rosidl_typesupport_introspection_c__BoundingBoxes_message_member_array[2] = {
  {
    "header",  // name
