#!/usr/bin/env python3
"""ROS 2 node that runs Ultralytics YOLO inference and publishes
bboxes_ex_msgs/BoundingBoxes using an Ultralytics YOLO model."""
...
class UltralyticsDetectorNode(Node):
    def __init__(self):
        ...
        self.sub_image = self.create_subscription(
            Image, src_topic, self.image_callback, 10)
