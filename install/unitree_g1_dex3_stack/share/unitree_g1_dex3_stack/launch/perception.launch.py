...
def launch_setup(context, *args, **kwargs):
    ...
    detector_library_path = '/home/unitree/.local/cudss/lib'
    ...
    detector_node = Node(
        ...
        parameters=[{
            ...
            "src_image_topic_name": '/camera/camera/color/image_raw',
        ...
        additional_env={
            'LD_LIBRARY_PATH': (
                detector_library_path if not existing_library_path
                else detector_library_path + ':' + existing_library_path
            ),
        },
    )
